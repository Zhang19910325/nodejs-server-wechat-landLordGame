/**
 * Created by zhangmiao on 2018/5/26.
 */
var SessionService = require("../common/service/backendSessionService");
var utils = require("../util/utils");

module.exports = function(app, opts){
    var cmp = new Component(app, opts);
    app.set('backendSessionService', cmp, true);
    return cmp;
};
...
Component.prototype.name = '__backendSession__';
